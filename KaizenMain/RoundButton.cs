...
namespace KaizenMain
{
    class RoundButton:Button
    {
        ...
        private Color _onHoverBorderColor = Color.FromArgb(8, 46, 65);
        private Color _buttonColor = Color.SteelBlue;
        private Color _onHoverButtonColor = Color.White;
        private Color _textColor = Color.White;
        private Color _onHoverTextColor = Color.FromArgb(8, 46, 65);
